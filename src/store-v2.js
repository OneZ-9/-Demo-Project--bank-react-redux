...
// unlike useReducer we cannot pass dispatch into reducer directly in Redux, we pass it into store.dispatch
// so when we have multiple reducer functions, we have to combine them into rootReducer and pass into store as below using combineReducer function provided by Redux
...
store.dispatch(createCustomer("Chamod Tharuka", "5446466"));
